% ----------------------------------------------------------------------
\begin{frame}[fragile,shrink]{A first encoding}
\lstinputlisting{encoding/encodings/queens0.lp}
\end{frame}
% ----------------------------------------------------------------------
...
\end{block}%
\begin{picture}(0,0)
  \put(250,20){\visible<3>{\chessboard[tinyboard,setpieces={Qa3,Qb7,Qc2,Qd8,Qe5,Qf1,Qg4,Qh6}]}}
\end{picture}
\end{frame}
% ----------------------------------------------------------------------
...
\begin{frame}{Enumerating diagonals}
  \begin{block}{\alert<1-3>{$\mathtt{n}=4$}}
  \quad
